...
<div class="container settings">
    <div class="row justify-content-center">
        <div class="col-md-3">
            <div class="list-group mb-3 shadow" id="list-tab" role="tablist">
                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            ...
                            <div class="row px-3">
                                    ...
                                    <div class="file-upload">
                                        <div class="form-group">
                                            <form action="#" id="profile-picture-form">
                                                <p class="m-1">Clear frontal face photos are important for buyers and
                                                    sellers to
                                                ...
                                                <small id="fileHelpId" class="form-text text-muted">*Only image files
                                                    are
                                                    accepted.</small>
                                            </form>
                                        </div>
                                ...
                                <h3>Profile Banner <i class="mdi mdi-image-area"></i></h3>
                                <div class="row mb-3">
                                ...
                                <div class="file-upload">
                                    <div class="form-group">
                                        ...
                                        <form action="#" id="profile-banner-form">
                                            <p class="m-1">Choose an appropriate banner. Images will not be resized.</p>
                                            <label class="file-upload-label text-center btn btn-outline-secondary"
                                                for="profile-pic-upload">Upload a Photo</label>
                                            <input type="file" class="form-control-file file-upload-input"
                                                name="file-upload" id="profile-banner-upload" placeholder=""
                                                aria-describedby="fileHelpId2" accept="image/*" hidden>
                            ...
                            <div class="row px-3">
                                <div class="col">
                                    <form id="personal-info-form">
                                        <div class="form-group">
                                            <label for="seller-name">Seller Name <small class="text-muted"> (This shall
                                                    be the
                                        ...
                                        <div class="form-group mb-0">
                                            <label for="fname">Mobile Number <small class="text-muted"> (Show or Hide
                                                    your
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small id="about-me-chars" class="text-muted">255</small><small
                                                class="text-muted">
                                                /255</small>
                                        </div>
                                        <div class="form-group">

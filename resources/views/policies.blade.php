    ...
    <div class="">
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <a class="nav-item nav-link active" id="nav-tac-tab" data-toggle="tab" href="#nav-tac" role="tab"
                    aria-controls="nav-tac" aria-selected="true">Terms and Conditions</a>
                <a class="nav-item nav-link" id="nav-pp-tab" data-toggle="tab" href="#nav-pp" role="tab"
                    aria-controls="nav-pp" aria-selected="false">Privacy Policy</a>
            </div>
        </nav>
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane card shadow fade show active" id="nav-tac" role="tabpanel"
                aria-labelledby="nav-tac-tab">
                <h1 class="text-center m-2">Terms and Conditions</h1>

                <div class="col">
                    <p>Welcome to Findgum!</p>

                    <p>These terms and conditions outline the rules and regulations for the use of Findgum's Website,
                        located at findgum.com.</p>

                    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                        Findgum if you do not agree to take all of the terms and conditions stated on this page.</p>
                    ...
                    <p>We employ the use of cookies. By accessing Findgum, you agreed to use cookies in agreement with
                        the
                        Findgum's Privacy Policy.</p>
                    ...
                    <p>Unless otherwise stated, Findgum and/or its licensors own the intellectual property rights for
                        all
                        material on Findgum. All intellectual property rights are reserved. You may access this from
                        Findgum
                        for your own personal use subjected to restrictions set in these terms and conditions.</p>

                    <p>You must not:</p>
                    <ul>
                        <li>Republish material from Findgum</li>
                        <li>Sell, rent or sub-license material from Findgum</li>
                        <li>Reproduce, duplicate or copy material from Findgum</li>
                        <li>Redistribute content from Findgum</li>
                    </ul>
                    ...
                    <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                        information in
                        certain areas of the website. Findgum does not filter, edit, publish or review Comments prior to
                        their presence on the website. Comments do not reflect the views and opinions of Findgum,its
                        agents
                        and/or affiliates. Comments reflect the views and opinions of the person who post their views
                        and
                        opinions. To the extent permitted by applicable laws, Findgum shall not be liable for the
                        Comments
                    ...
                    <p>Findgum reserves the right to monitor all Comments and to remove any Comments which can be
                        considered
                    ...
                    <p>You hereby grant Findgum a non-exclusive license to use, reproduce, edit and authorize others to
                        use,
                    ...
                    <p>We will approve link requests from these organizations if we decide that: (a) the link would not
                        ...
                        compensates
                        the absence of Findgum; and (d) the link is in the context of general resource information.</p>
                    ...
                    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to
                        our
                        website, you must inform us by sending an e-mail to Findgum. Please include your name, your
                    ...
                    <p>No use of Findgum's logo or other artwork will be allowed for linking absent a trademark license
                        agreement.</p>
            ...
            {{--  --}}
            <div class="tab-pane card shadow fade" id="nav-pp" role="tabpanel" aria-labelledby="nav-pp-tab">
                <h1 class="text-center m-2">Privacy Policy</h1>

                <div class="col">
                    <p>Your privacy is important to us. It is Findgum's policy to respect your privacy regarding any
                        information we may collect from you across our website, <a
                            href="http://www.findgum.com">http://www.findgum.com</a>, and other sites we own and
                        operate.</p>
                    ...
                    <p>This policy is effective as of 1 October 2022.</p>
                </div>
            </div>
        </div>
    </div>

            ...
            <ul class="navbar-nav mx-auto">
                <li class="nav-item dropdown megamenu-list">
                    <a class="dropdown-toggle btn btn-link megamenu-category" role="button" href="#" id="mega-1"
                        ...
                        Cars & Accessories <i class="mdi mdi-car" aria-hidden="true"></i><span class="caret"></span>
                    </a>
                ...
                <li class="nav-item dropdown megamenu-list">
                    <a class="dropdown-toggle btn btn-link megamenu-category" role="button" href="#" id="mega-2"
                        role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                        Mobile Phones and Electronics <i class="mdi mdi-tablet-cellphone" aria-hidden="true"></i><span class="caret"></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-left animate slideIn megamenu-item shadow"
                ...
                <li class="nav-item dropdown megamenu-list">
                    <a class="dropdown-toggle btn btn-link megamenu-category" role="button" href="#" id="mega-3"
                        role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                        Job & Opportunity <i class="mdi mdi-account-supervisor" aria-hidden="true"></i><span class="caret"></span>
                    </a>
                ...
                <li class="nav-item dropdown megamenu-list">
                    <a class="dropdown-toggle btn btn-link megamenu-category" role="button" href="#" id="mega-4"
                        role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                        Real Estate and Property <i class="mdi mdi-home-city" aria-hidden="true"></i><span class="caret"></span>
                    </a>
                ...
                <li class="nav-item dropdown megamenu-list">
                    <a class="dropdown-toggle btn btn-link megamenu-category" role="button" href="#" id="mega-5"
                        role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                        Fashion Statement<i class="mdi mdi-human-male-female" aria-hidden="true"></i><span class="caret"></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right animate slideIn megamenu-item shadow"
                ...
                <li class="nav-item dropdown megamenu-list">
                    <a class="dropdown-toggle btn btn-link megamenu-category" role="button" href="#" id="mega-4"
                        role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                        Health & Beauty <i class="mdi mdi-hand-heart" aria-hidden="true"></i><span class="caret"></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right animate slideIn megamenu-item shadow"
                        aria-labelledby="mega-4">
                        <div class="row">

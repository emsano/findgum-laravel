		...
		<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4">
			...
			<div class="col mb-4 product-card">
				<div class="card">
					...
					<div class="card-body">
						<h5 class="card-title product-title"><a href="#" class="card-link text-danger like">Vans Sk8-Hi MTE Shoes</a></h5>
					...
					<div class="card-footer bg-transparent border-success">
						<p class="product-price mb-0">&#8369; 5000 </p>
						<p class="product-card-location mb-0"><i class="mdi mdi-google-maps"></i><span> Baguio City</span></p>
					</div>
				</div>
			</div>
			@endfor
		...
		<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4">
			...
			<div class="col mb-4 product-card">
				<div class="card">
					...
					<div class="card-body">
						<h5 class="card-title product-title"><a href="#" class="card-link text-danger like">Vanguard Power</a></h5>
						<p class="card-text product-desc">
							If you need a tough, commercial grade engine that makes you more productive, look to Vanguard.</p>
					</div>
					<div class="card-footer bg-transparent border-success">
						<p class="product-price mb-0">&#8369; 999999 </p>
						<p class="product-card-location mb-0"><i class="mdi mdi-google-maps"></i><span> Pampanga</span></p>
					</div>
				</div>
			</div>
			@endfor
